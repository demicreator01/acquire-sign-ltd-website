...
const WATCHES = [
    { id: 1, name: 'Rolex Submariner', image: 'https://images.unsplash.com/photo-1662990209247-7ddb7ca0fccd?q=70&w=600&auto=format&fit=crop' },
    { id: 2, name: 'Audemars Piguet Royal Oak', image: 'https://images.unsplash.com/photo-1729078945948-4485f0a58494?q=70&w=600&auto=format&fit=crop' },
    { id: 3, name: 'Patek Philippe Calatrava', image: 'https://images.unsplash.com/photo-1642984120374-da83fef6bb20?q=70&w=600&auto=format&fit=crop' },
    { id: 4, name: 'Cartier Santos', image: 'https://images.unsplash.com/photo-1609482806891-7b1b31891da3??q=70&w=600&auto=format&fit=crop' },
    { id: 5, name: 'Hublot Classic Fusion', image: 'https://images.unsplash.com/photo-1629581678313-36cf745a9af9?q=70&w=600&auto=format&fit=crop' },
    { id: 6, name: 'Richard Mille RM 11', image: 'https://images.unsplash.com/photo-1548171915-e79a380a2a4b?q=70&w=600&auto=format&fit=crop' },
];
